...
test('correct task should be deleted from correct array', () => {
    const action = tasksThunk.removeTask.fulfilled({taskId: '2', todolistId: "todolistId2"}, 'requestId', {taskId: '2', todolistId: "todolistId2"})
...
test('propertry with todolistId should be deleted', () => {
    const action = todolistsActions.removeTodolistAC({id: "todolistId2"});
...
test('tasks should be added for todolist', () => {
    //const action = tasksActions.setTasksAC({tasks: startState["todolistId1"], todolistId: "todolistId1"});
    const action = tasksThunk.fetchTasks.fulfilled ({tasks: startState["todolistId1"], todolistId: "todolistId1"}, 'requestId', "todolistId1");
